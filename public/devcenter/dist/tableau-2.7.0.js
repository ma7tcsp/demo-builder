...
(function() {
  ...
  (function() {
    ...
    var $tab_CrossDomainMessager = global.tab.CrossDomainMessager = 
    ss.mkType($asm, 'tab.CrossDomainMessager', 
    function(legacyHandler) {
      ...
      if ($tab__Utility.hasWindowAddEventListener()) {
        ...
        //ANTHONY MODIFICATION FOR IFRAME HIERARCHY, LEVEL 2
        // for(let i=0;i<$("iframe").length;i++){
        //   $("iframe")[i].contentWindow.addEventListener('message', ss.mkdel(this, this.$handleCrossDomainMessage), true);
        // }
        //ANTHONY MODIFICATION FOR IFRAME HIERARCHY, LEVEL 2
      }
    ...
    }, 
    {
      ...
      $handleCrossDomainMessage: function CrossDomainMessager$HandleCrossDomainMessage(e) {
        ...
        if(e.isTrusted)
          ...
          messageEvent = ss.cast(e, MessageEvent);
