...
var VERSION="1.02",DEFAULT_SETTINGS="default",NO_FILTER_TEXT="Activate View at Least Once to Setup...",WARNTABS="This workbook has hidden tabs, switching views and keeping filter state could not be possible ! Consider changing to 'Tabbed Views'.",currentTemplate,crossMessageHandler,magicGrid,pickers=[],panelSet,viewsModified=!1,curSearch,curSearchVarC,isTemplateLoaded,firiendlyTpName={"templates/grid/index.html":"Horizontal","templates/gridV/index.html":"Vertical","templates/bs/index.html":"BootStrap",
"templates/gridstack/index.html":"Widgets","templates/lightboot/examples/dashboard.html":"Creative","templates/amd/index.html":"AMD"};Window.prototype._addEventListener=Window.prototype.addEventListener;Window.prototype.addEventListener=function(a,b,c){"message"===a&&(crossMessageHandler=b);void 0==c&&(c=!1);this._addEventListener(a,b,c);this.eventListenerList||(this.eventListenerList={});this.eventListenerList[a]||(this.eventListenerList[a]=[]);this.eventListenerList[a].push({listener:b,options:c})};
...
f);reloadMe(!0)}}function openExportOptions(a){a.stopPropagation();showModal("modal-export");$(".gogo").focus();$("#exportname").val(firiendlyTpName[currentTemplate])}function exportOptions(a){MicroModal.close("modal-export");1==a&&(exportTemplate($("#exportname").val()),setTimeout(function(){$("#exportconf").prop("checked")&&saveToFile($("#exportname").val())},1E3))}
