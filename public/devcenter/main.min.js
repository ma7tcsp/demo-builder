...
b){console.log("ACCCHHCH",$(b.parentElement).find(".filter-entry[varc='"+$(b).attr("varc")+"']").prop("checked"));saveToRepo("text","Filter-text-"+$(b).attr("varc"),encodeURIComponent($(b).prop("value")));restoreTexts()});$("#imglist .imgs").each(function(a,b){saveToRepo("img",$(b).attr("varc"),$(b).prop("value"));restoreImgs()});a&&closeSettings();1==viewsModified?(switchTemplate(currentTemplate),viewsModified=!1):$(".page-content").css("opacity","1")}
