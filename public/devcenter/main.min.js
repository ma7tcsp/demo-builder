...
function closeAllMenu(){$(".sidebar-dropdown").removeClass("active");$(".sidebar-submenu").hide()}function switchTemplate(a,b){$("#template").prop("src",a);b&&closeSettings();b&&($(".thumb.templ").removeClass("active"),$(b).addClass("active"),$(".sidebar-menu .sidebar-submenu details .fas").hide(),$(b).find("i").show());currentTemplate=a;disposeAllViz();$("#container").empty();clearInterval(isTemplateLoaded);restoreViz()}
