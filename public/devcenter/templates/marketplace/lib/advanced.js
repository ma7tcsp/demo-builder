...
function setCarousel(){
    ...
    if(s!=""){
      ...
      <div class="col mb-5">
        <div class="card h-100">
            ...
            <!-- Product image-->
            <img class="card-img-top" src="${s}.png" alt="..." />
            <!-- Product details-->
            <div class="card-body p-4">
                <div class="text-center">
                    <!-- Product name-->
                    <h5 id="Viz-${ind +1}-text" class="fw-bolder editable">Sale Item</h5>
                    <!-- Product price-->
            ...
            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="#">Subscribe</a></div>
            </div>
        </div>
      </div>
      `
  ...
  document.querySelector(`#carousel`).innerHTML+=popu;
}
